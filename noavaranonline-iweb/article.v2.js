...
var content_box_1 = iframeContentWrapper({
    ...
    "name": "noavaranonline-iweb",
    "build": IframeBuildWrapper,
    "custom_inner_css": {
        yektanet_div: '{id}{color:#000000;background-color:#ffffff;}',
        heading: '{id} .yektanet-articles__heading{color:#000000;background-color:#ffffff;}',
        heading_branding: '{id} .yektanet-articles__heading-branding{color:#000000;background-color:#ffffff;}',
        item_title: '{id} .item__title{color:#000000;font-size:14px;font-weight:600;background-color:#ffffff;}',
